...
export const students: Student[] = [
  { id: 'student-1', name: 'Alice', usesBus: true, grade: '5', parentName: 'John Doe', parentContact: '555-1234', address: '123 Main St, Anytown, USA', busNumber: 'B-101' },
  { id: 'student-2', name: 'Bob', usesBus: false, grade: '3', parentName: 'Jane Smith', parentContact: '555-5678', address: '456 Oak Ave, Anytown, USA' },
  { id: 'student-3', name: 'Charlie', usesBus: true, grade: '7', parentName: 'Peter Jones', parentContact: '555-8765', address: '789 Pine Ln, Anytown, USA', busNumber: 'B-102' },
  { id: 'student-4', name: 'David', usesBus: true, grade: '5', parentName: 'Mary Brown', parentContact: '555-4321', address: '321 Maple Dr, Anytown, USA', busNumber: 'B-101' },
  { id: 'student-5', name: 'Eve', usesBus: false, grade: '4', parentName: 'David Williams', parentContact: '555-9876', address: '654 Elm St, Anytown, USA' },
  { id: 'student-6', name: 'Frank', usesBus: true, grade: '2', parentName: 'Susan Garcia', parentContact: '555-3456', address: '987 Birch Rd, Anytown, USA', busNumber: 'B-103' },
  { id: 'student-7', name: 'Grace', usesBus: true, grade: '6', parentName: 'Robert Miller', parentContact: '555-6543', address: '159 Cedar Blvd, Anytown, USA', busNumber: 'B-102' },
  { id: 'student-8', name: 'Heidi', usesBus: false, grade: '8', parentName: 'Patricia Davis', parentContact: '555-7890', address: '753 Spruce Way, Anytown, USA' },
  { id: 'student-9', name: 'Ivan', usesBus: true, grade: '1', parentName: 'Michael Rodriguez', parentContact: '555-1122', address: '852 Fir Ct, Anytown, USA', busNumber: 'B-104' },
  { id: 'student-10', name: 'Judy', usesBus: true, grade: '5', parentName: 'Linda Martinez', parentContact: '555-3344', address: '951 Redwood Pkwy, Anytown, USA', busNumber: 'B-101' },
  { id: 'student-11', name: 'Mallory', usesBus: true, grade: '7', parentName: 'James Hernandez', parentContact: '555-5566', address: '357 Aspen Grove, Anytown, USA', busNumber: 'B-105' },
  { id: 'student-12', name: 'Niaj', usesBus: false, grade: '3', parentName: 'Barbara Lopez', parentContact: '555-7788', address: '246 Willow Creek, Anytown, USA' },
  { id: 'student-13', name: 'Olivia', usesBus: true, grade: '6', parentName: 'William Gonzalez', parentContact: '555-9900', address: '135 Poplar Pl, Anytown, USA', busNumber: 'B-102' },
  { id: 'student-14', name: 'Peggy', usesBus: true, grade: '2', parentName: 'Richard Wilson', parentContact: '555-2468', address: '791 Sequoia Trail, Anytown, USA', busNumber: 'B-103' },
  { id: 'student-15', name: 'Sybil', usesBus: false, grade: '4', parentName: 'Joseph Anderson', parentContact: '555-1357', address: '975 Cypress Point, Anytown, USA' },
];
