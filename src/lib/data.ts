...
export const students: Student[] = [
  { id: 'student-1', name: 'Alice', usesBus: true, grade: '5', parentName: 'John Doe', parentContact: '555-1234', address: '123 Main St, Anytown, USA' },
  { id: 'student-2', name: 'Bob', usesBus: false, grade: '3', parentName: 'Jane Smith', parentContact: '555-5678', address: '456 Oak Ave, Anytown, USA' },
  { id: 'student-3', name: 'Charlie', usesBus: true, grade: '7', parentName: 'Peter Jones', parentContact: '555-8765', address: '789 Pine Ln, Anytown, USA' },
  { id: 'student-4', name: 'David', usesBus: true, grade: '5', parentName: 'Mary Brown', parentContact: '555-4321', address: '321 Maple Dr, Anytown, USA' },
  ...
  { id: 'student-6', name: 'Frank', usesBus: true, grade: '2', parentName: 'Susan Garcia', parentContact: '555-3456', address: '987 Birch Rd, Anytown, USA' },
  { id: 'student-7', name: 'Grace', usesBus: true, grade: '6', parentName: 'Robert Miller', parentContact: '555-6543', address: '159 Cedar Blvd, Anytown, USA' },
  ...
  { id: 'student-9', name: 'Ivan', usesBus: true, grade: '1', parentName: 'Michael Rodriguez', parentContact: '555-1122', address: '852 Fir Ct, Anytown, USA' },
  { id: 'student-10', name: 'Judy', usesBus: true, grade: '5', parentName: 'Linda Martinez', parentContact: '555-3344', address: '951 Redwood Pkwy, Anytown, USA' },
  { id: 'student-11', name: 'Mallory', usesBus: true, grade: '7', parentName: 'James Hernandez', parentContact: '555-5566', address: '357 Aspen Grove, Anytown, USA' },
  ...
  { id: 'student-13', name: 'Olivia', usesBus: true, grade: '6', parentName: 'William Gonzalez', parentContact: '555-9900', address: '135 Poplar Pl, Anytown, USA' },
  { id: 'student-14', name: 'Peggy', usesBus: true, grade: '2', parentName: 'Richard Wilson', parentContact: '555-2468', address: '791 Sequoia Trail, Anytown, USA' },
